...
#include "voyage/cotila/detail/type_traits.h"
 ...
 *  @param v an N-vector of type T
 *  @return an N-vector \f$ \begin{bmatrix} \sqrt{v_1} & \ldots &\sqrt{v_N}
 * \end{bmatrix} \f$ of type T
 *
 ...
 *  @param v an N-vector of type T
 *  @return an N-vector \f$ \begin{bmatrix} \lvert v_1 \rvert & \ldots & \lvert
 * v_N \rvert \end{bmatrix} \f$ of type T
 *
 ...
 *  @param v an N-vector of type T
 *  @return a scalar \f$ v_i \f$ of type T where \f$ v_i \leq v_j,\ \forall j
 * \f$
 *
 ...
 *  @param v an N-vector of type T
 *  @return a scalar \f$ v_i \f$ of type T where \f$ v_i \geq v_j,\ \forall j
 * \f$
 *
