 ...
 *  @return true if and only if \f$ \textbf{a}_i = \textbf{b}_i\ \forall i \in
 * 1\ .. N \f$
 *
 ...
 *  @param a an N-vector of type T
 *  @param b an N-vector of type T
 *  @return false if and only if \f$ \textbf{a}_i = \textbf{b}_i\ \forall i \in
 * 1\ .. N \f$
 *
 ...
 *  @return \f$ \textbf{v} + a \f$ such that \f$ \left(\textbf{v} + a\right)_i =
 * \textbf{v}_i + a \f$
 *
 ...
 *  @param a a scalar of type T
 *  @param v an N-vector of type T
 *  @return \f$ a + \textbf{v} \f$ such that \f$ \left(a + \textbf{v}\right)_i =
 * a + \textbf{v}_i \f$
 *
 *  Computes the sum of a vector and a scalar.
 */
 ...
 * \textbf{b}\right)_i = \textbf{a}_i + \textbf{b}_i \f$
 *
 ...
 * \circ \textbf{b}\right)_i = \textbf{a}_i \textbf{b}_i \f$
 *
 ...
 * \left(\textbf{b}_i\right)^{-1}\f$ and \f$ \left(\textbf{a} \circ
 * \textbf{b}'\right)_i = \textbf{a}_i {\textbf{b}'}_i \f$
 *
