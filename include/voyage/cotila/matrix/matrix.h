 ...
 *  \code{.cpp}
 *  cotila::matrix m{{{1., 2.}, {3., 4.}}}; // deduces the type of m to be
 * cotila::matrix<double, 2, 2>
 *  \endcode
 */
 ...
 *  This deduction guide allows cotila::matrix to be constructed like this:
 *  \code{.cpp}
 *  cotila::matrix m{{{{1., 0.}, {2., 1.}}, {{3., 2.}, {4., 3.}}}}; // deduces
 * the type of m to be cotila::matrix<std::complex<double>, 2, 2>
 *  \endcode
 */
template <typename T, std::size_t M, std::size_t N>
